...
try:
    ...
    print 'file open error:',e #file open error: [Errno 2] No such file or directory: 'test_013.py'
...
print addMe2Me.__getattribute__ #<method-wrapper '__getattribute__' of function object at 0x105ca8b90>
